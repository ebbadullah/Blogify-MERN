    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <nav className="-mb-px flex space-x-8">
            {[
              ...
              <button
                ...
                className={`group inline-flex items-center pb-4 px-1 border-b-2 font-medium text-sm ${activeTab === tab.id ? "border-black text-black" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"} transition-colors duration-300`}
              >
                <span
        ...
        {currentPosts?.length === 0 ? (
          <AnimatedSection className="text-center py-16 bg-white rounded-2xl border border-gray-100 shadow-sm">
            <BookOpen className="h-16 w-16 mx-auto text-gray-400" />
            <h3 className="mt-6 text-xl font-serif font-medium text-gray-900">
              {activeTab === "posts" ? "No posts yet" : activeTab === "saved" ? "No saved posts" : "No drafts"}
            </h3>
          ...
          >
            {currentPosts?.map((post, index) => (
              <motion.div
                ...
                className="group bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-all duration-500"
              >
