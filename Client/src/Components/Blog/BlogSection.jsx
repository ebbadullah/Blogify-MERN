  ...
  return (
    <section ref={scrollRef} className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
            <div className="relative flex-grow max-w-md">
              ...
              <input
                ...
                className="w-[300px] pl-12 pr-4 py-4 bg-white border border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-all duration-300 shadow-sm"
              />
            </div>
        ...
        {/* Featured Article using BlogArticle */}
        {/* {featuredPost && !searchQuery && activeCategory === "All" && (
          <div className="mb-24">
            <BlogArticle post={featuredPost} variant="large" />
          </div>
        )} */}
              ...
              {visiblePosts < filteredPosts.length && (
                <div className="text-center mt-12">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 bg-black text-white font-medium rounded-xl hover:bg-gray-800 transition-colors duration-300 shadow-lg"
                  >
                    Load More Articles
                  </motion.button>
                </div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-grow px-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-all duration-300 shadow-sm"
              />
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="px-6 py-4 bg-black text-white font-medium rounded-xl flex items-center justify-center hover:bg-gray-800 transition-colors duration-300 shadow-lg"
              >
                Subscribe
