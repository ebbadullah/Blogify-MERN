        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              We're on a mission to create a platform where writers can share
              their knowledge and readers can discover valuable insights.
            </p>
          </div>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Our platform connects writers and readers from around the
                    world, fostering a global community of knowledge sharing.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Built with the latest technologies to ensure a fast,
                    responsive, and enjoyable experience for all users.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Join discussions, share feedback, and connect with
                    like-minded individuals in our thriving community.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    We prioritize high-quality, valuable content that educates,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <div className="mt-6">
                <h3 className="text-lg font-medium text-black">Arshil Mirza</h3>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Whether you're a writer looking to share your knowledge or a
              reader seeking valuable insights, we welcome you to join our
              community.
            </p>
