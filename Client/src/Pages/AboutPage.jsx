            ...
            <div className="mt-16">
              <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                <div className="relative">
                  ...
                  <div className="ml-16">
                    <h3 className="text-lg leading-6 font-medium text-black">Global Reach</h3>
                    <p className="mt-2 text-base text-gray-500">
                      Our platform connects writers and readers from around the world, fostering a global community of
                      knowledge sharing.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="ml-16">
                    <h3 className="text-lg leading-6 font-medium text-black">Fast & Modern</h3>
                    <p className="mt-2 text-base text-gray-500">
                      Built with the latest technologies to ensure a fast, responsive, and enjoyable experience for all
                      users.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="ml-16">
                    <h3 className="text-lg leading-6 font-medium text-black">Engaged Community</h3>
                    <p className="mt-2 text-base text-gray-500">
                      Join discussions, share feedback, and connect with like-minded individuals in our thriving
                      community.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="ml-16">
                    <h3 className="text-lg leading-6 font-medium text-black">Quality Content</h3>
                    <p className="mt-2 text-base text-gray-500">
