      ...
      <div className="min-h-screen bg-white">
        <div className="bg-black text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-lg text-gray-300">Have questions or feedback? We'd love to hear from you.</p>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 max-w-3xl mx-auto">
              <div className="space-y-8">
                <div>
                  <h3 className="text-lg font-medium text-black">How do I create an account?</h3>
                  <p className="mt-2 text-base text-gray-500">
                ...
                <div>
                  <h3 className="text-lg font-medium text-black">Is it free to create a blog?</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Yes, creating and publishing blogs on our platform is completely free. We also offer premium features
                    for users who want additional customization options and analytics.
                  </p>
                </div>
  
                <div>
                  <h3 className="text-lg font-medium text-black">How can I monetize my blog?</h3>
                  <p className="mt-2 text-base text-gray-500">
                    We offer various monetization options including ad revenue sharing, sponsored content opportunities,
                    and premium subscriptions. You can learn more about these options in your account settings once you've
                    signed up.
                  </p>
                </div>
  
                <div>
                  <h3 className="text-lg font-medium text-black">Can I import my existing blog?</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Yes, we provide tools to import content from other platforms. You can find the import options in your
