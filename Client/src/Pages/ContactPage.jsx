                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      ...
                      content: (
                        <a
                          href="mailto:ebad@devVertax.com"
              ...
              {[
                {
                  ...
                  answer:
                    'You can create an account by clicking on the "Sign up" button in the top right corner of the page. Fill in your details and follow the instructions to complete the registration process.',
                },
                {
                  question: "Is it free to create a blog?",
                  answer:
                    "Yes, creating and publishing blogs on our platform is completely free. We also offer premium features for users who want additional customization options and analytics.",
                },
                {
                  question: "How can I monetize my blog?",
                  answer:
                    "We offer various monetization options including ad revenue sharing, sponsored content opportunities, and premium subscriptions. You can learn more about these options in your account settings once you've signed up.",
                },
                {
                  question: "Can I import my existing blog?",
                  answer:
                    "Yes, we provide tools to import content from other platforms. You can find the import options in your dashboard after creating an account.",
                },
              ].map((faq, index) => (
                <motion.div
                  key={index}
